    ...
    public function getVoucher($id) {
        ...
        $ret.="
                        <tr>
                            ...
                            <td width='70%'><strong>". FinGeneralLedgerController::getReference($finGeneralLedger->txn_type,$finGeneralLedger->txn_series,3) ."</strong></td>
                        </tr>
                        <tr>
...
$r = '<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  ...
  <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
    ...
    public function bulkApproveLedger(Request $request){


        if(!empty($request->gin_ledger_approve)){
            foreach ($request->gin_ledger_approve as $val){
                FinGeneralLedger::where('id',$val)->update(array('voucher_status'=>3));
            }
        }
        return redirect()->route('fin-general-ledgers.vouchers')
