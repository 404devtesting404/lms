...
{{--                        <th>Profit Amount Rec.</th>--}}
                ...
                <tbody>
                    ...
                    <tr  class="border-blue">
                        ...
                        <td>{{ isset($mod_amount[$ReportRow->loan_id]) ? number_format(($mod_amount[$ReportRow->loan_id]+$ReportRow->finance_amount),0) : number_format($ReportRow->finance_amount,0) }}</td>
                        <td>{{
