...
@section('page_title', 'Over Due Report')
@section('content')

<div class="card card-default">
    <div class="card-header">
        <span class="card-title">Over Due Report</span>
    </div>
    <div class="card-body">
        @if(isset($datef))
...
<table class="table datatable-button-html5-columns">
            <thead style="background-color: #26a69a; color: #FFF;">
                ...
                <tr class="datatable-header center"  >
                    ...
                    <th colspan="3" style="text-align: center; border-width: 0px 1px 0px 1px;">Over Due</th>
...
<!--                    <th rowspan="2">Last Recovery Date</th>-->
            ...
            <tbody>
                ...
                <tr  class="border-blue">
                    ...
                    <td>{{ $ReportRow->days_until_now }}</td>
...
<!--                    <td>{{ $ReportRow->b_name }}</td>-->
        ...
        <form method="POST" action="{{ route('reports.overduesreport') }}"  role="form" enctype="multipart/form-data">
            @csrf
