    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-2">
                    <br>
                    <label style="padding-top: 15px">Show all &nbsp; <input style="height: 20px;width: 20px" type="checkbox" id="show_all_login"></label>
                </div>
                <div class="col-md-2">
                    <br>
                    <button id="search_log" type="button" onclick="getLoginActivity()" class="btn btn-primary btn-xs"><i class="icon-search4"></i> Search</button>
                </div>
            </div>
            <br>
            <div class="col-12">
